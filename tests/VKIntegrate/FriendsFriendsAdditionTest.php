...
use MGGFLOW\VK\API;
use MGGFLOW\VK\Automatic\Tasks\FriendsFriendsAddition;
use PHPUnit\Framework\TestCase;

class FriendsFriendsAdditionTest extends TestCase
{
    protected API $api;
    ...
    public function testExecute()
    {
        ...
        $task = new FriendsFriendsAddition($this->api, $taskData);
        $this->result = $task->execute();

        $this->assertNotEmpty($this->result->friendFriendsResult->friendFriends);
