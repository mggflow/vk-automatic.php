...
use MGGFLOW\VK\API;
use MGGFLOW\VK\Automatic\Tasks\SuggestionFriendsAddition;
use PHPUnit\Framework\TestCase;

class SuggestionFriendsAdditionTest extends TestCase
{
    protected API $api;
    ...
    public function testExecute()
    {
        ...
        $task = new SuggestionFriendsAddition($this->api, $taskData);
        $this->result = $task->execute();

        $this->assertNotEmpty($this->result->suggestionsResult->suggestionUsers);
